...
> Calculate the [variance][variance] of a one-dimensional ndarray.
...
```javascript
variance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-variance@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-ndarray-variance/tags). For example,

```javascript
variance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-variance@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var variance = require( 'path/to/vendor/umd/stats-base-ndarray-variance/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-variance@umd/browser.js"></script>
```
...
Computes the [variance][variance] of a one-dimensional ndarray.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-ndarray-variance.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-ndarray-variance

[test-image]: https://github.com/stdlib-js/stats-base-ndarray-variance/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-base-ndarray-variance/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-ndarray-variance/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-ndarray-variance?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-ndarray-variance.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-ndarray-variance/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-ndarray-variance/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-ndarray-variance/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-ndarray-variance/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-ndarray-variance/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-ndarray-variance/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-ndarray-variance/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-ndarray-variance/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-ndarray-variance/main/LICENSE
